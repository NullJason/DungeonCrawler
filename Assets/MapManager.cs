...
public class MapManager : MonoBehaviour
{
    ...
    public void CreateNextArea(){
        ...
        CreateExits(NumExits, RoomClone, PathPositions);

        EnqueueSpawnPoints(SpawnPointsFolder, SpawnPoints);

        // get room's enemy data.
        Transform EnemyFolder = RoomClone.transform.Find("Enemies");
        int RngEnemyCount = EnemyFolder.childCount;
        string[] ENames = GetEnemyNamesArray(RngEnemyCount, EnemyFolder);

	AddToLuck(ENames);

        Queue<GameObject> EnemyQueue = new Queue<GameObject>();
	AppendEnemiesRandom(EnemyQueue, EnemyFolder);
    ...
    // create the exits.
    //
    // This method was auto-generated by Step from code originally in CreateNextArea. 
    // Creates a number of exits from a room, removing duplicates. 
    // NumExits refers to the number of exits that should be generated. 
    // RoomClone appears to refer to which room a given exit leads to? Unclear. 
    // PathPosition appears to refer to the transform whose children represent different directions. 
    private protected void CreateExits(int NumExits, GameObject RoomClone, Transform PathPositions){
    ...
    //
    // This method was auto-generated by Step from code originally in CreateNextArea. 
    // Gets the positions of each child attached to a Transform, and adds them to a Queue.
    // SpawnPointsFolder refers to the Transform whose children should be added to the queue. 
    // SpawnPoints refers to the queue to which we add the children's positions. 
    // Note: This method was originally meant to get spawn points under a particular transform, and the method and parameter names currently reflect this. 
    // TODO: Make method more generic-looking
    private protected void EnqueueSpawnPoints(Transform SpawnPointsFolder, Queue<Vector3> SpawnPoints){
    ...
    //
    // This method was auto-generated by Step from code originally in CreateNextArea. 
    // Converts a Transform with children into an array of each child's names. 
    // RngEnemyCount represents how many children the Transform has. 
    //     Note that this is not enforced, and if there are actually fewer children than RngEnemyCount, exceptions might occur!
    // EnemyFolder represents the Transform which we get the children of. 
    // Note: This method was originally meant to get arrays from a transform that was used to store enemies, and the method and parameter names currently reflect this. 
    // TODO: Make method more generic-looking
    // TODO: Add checks to replace or enforce RngEnemyCount 
    private string[] GetEnemyNamesArray(int RngEnemyCount, Transform EnemyFolder){
    ...
    //
    // This method was auto-generated by Step from code originally in CreateNextArea. 
    // ENames is a list of the names of the enemies to be added. 
    private void AddToLuck(string[] ENames){
    ...
    //
    // This method was auto-generated by Step from code originally in CreateNextArea. 
    // EnemyQueue represents the queue that the enemies should be appended to. 
    // EnemyFolder is a transform whose children represent the various enemies that are randomly spawned. 
    //
    // TODO: Make it so you can customize how many enemies are enqueued?
    private void AppendEnemiesRandom(Queue<GameObject> EnemyQueue, Transform EnemyFolder){
